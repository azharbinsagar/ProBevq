    ...
    <div class="w3l-about1 card card_border p-lg-5 p-3 mb-4">
      <div class="card-body py-3 p-0">
            ...
            <?php } ?>
						...
						<div class="row">
						<?php 
						$pro = mysqli_query($con,"SELECT * FROM `product`  ORDER BY `pname`");
						while($pro1 = mysqli_fetch_object($pro))
									{
					?>
							<div class="col-md-3 col-sm-6">
								<div class="product-grid2">
									<div class="product-image2">
										<a href="#">
                      <?php echo "<img class=\"pic-1\" width=\"400\" height=\"400\" src=\"../images/$pro1->pid.1.jpg\">";?>
										</a>
                      <a href="placeorder.php?pid=<?php echo $pro1->pid; ?>"><button type="button" class="add-to-cart" class="btn btn-primary">Add to cart</button></a>
									</div>
									<div class="product-content">
										<h3 class="title"><a href="#"><?php echo $pro1->pname; ?> (<?php echo $pro1->cat; ?>) - <?php echo $pro1->qty; ?> litre</a></h3>
										<span class="price">₹<?php echo $pro1->amount; ?></span>
									</div>
								</div>
							</div>
							<?php
