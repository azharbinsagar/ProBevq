...
{
		$q1=mysqli_query($con,"DELETE FROM `product` WHERE `pid`='$pid'");
		if($q1)
		{
			$success_message="Product was deleted <script>setTimeout(function(){window.location=\"view_product.php\";},3000);</script><strong>Success</strong>, Product details changed.";
		}
		else
		{
      ...
      <div class="card-body py-3 p-0">
        <div class="row cwp23-content">
						...
						<section class="wrapper">
								...
								<h3 class="w3ls_head">Product Details</h3>
								<b>Are you sure want to delete this Product?</b><br><br>
						...
						<?php } ?>
								...
								<a href="view_product.php"><button type="button" class="btn btn-success">No</button></a>
								</form>
								</div>
						</section>
					</div>
