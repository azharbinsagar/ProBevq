...
$sid=$_GET["sid"];
$q3=mysqli_query($con,"SELECT `email` FROM `outlet` WHERE `sid`='$sid'");
$r1=mysqli_fetch_object($q3);
$uname=$r1->email;
if($_SERVER["REQUEST_METHOD"]=="POST")
{
		$q1=mysqli_query($con,"DELETE FROM `outlet` WHERE `sid`='$sid'");
		if($q1)
		{
			$q2=mysqli_query($con,"DELETE FROM `login` WHERE `username`='$uname'");
		if($q2)
		{
			$success_message="Shop was deleted <script>setTimeout(function(){window.location=\"view_outlet.php\";},3000);</script><strong>Success</strong>, Shop details changed.";
		}
		else
		{
      ...
      <div class="card-body py-3 p-0">
        <div class="row cwp23-content">
						...
						<section class="wrapper">
								...
								<h3 class="w3ls_head">Delete Shop</h3>
								<b>Are you sure want to delete this Shop?</b><br><br>
						...
						<?php } ?>
								...
								<a href="view_outlet.php"><button type="button" class="btn btn-success">No</button></a>
								</form>
								</div>
						</section>
					</div>
