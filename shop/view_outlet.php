      ...
      <div class="card-body py-3 p-0">
        <div class="row cwp23-content">
						...
						<div class="table table-responsive">
							...
							<thead> <tr> <th>S.No</th> <th>Shop Name</th>  <th>Licence Number</th> <th>Location</th> <th>Pincode</th> <th>Mobile Number</th> <th>Email</th><th>Update</th><th>Delete</th></tr> </thead>
							<tbody> 
										...
										while($obj=mysqli_fetch_object($result))
										{
											echo "<tr> <td>$c</td>";
													echo"
														...
														<td>$obj->phone</td>
														<td>$obj->email</td>
														<td><a href=\"edit_shop.php?sid=$obj->sid\">
														<i class=\"glyphicon glyphicon-edit\"></i></a></td>
														<td><a href=\"delete_shop.php?sid=$obj->sid\">
