      ...
      <div class="card-body py-3 p-0">
        <div class="row cwp23-content">
						...
						<div class="table table-responsive">
							...
							<thead> <tr> <th>S.No</th> <th>Product Name</th>  <th>Quantity </th> <th>Category</th> <th>Stock</th> <th>Amount</th> <th>Images</th><th>Delete</th></tr> </thead>
							<tbody> 
						

								<?php 
								//taking data from database
										$query = "SELECT * FROM `product`  WHERE `sid` = '$sid' ORDER BY `pname`";
                            ...
                            if($obj->img ==0){
                                echo "No Pictures Uploaded.<br><a href=\"uploadpropic.php?pid=$obj->pid\">Upload Now</a>";
                              }
                              else{
                                for($i=1;$i<=$obj->img;$i++){
                                  echo "<img src=\"../images/$obj->pid.$i.jpg\" width=\"50\" height=\"50\">&nbsp;&nbsp;&nbsp;";
                                }
                                echo "<br><a href=\"uploadpropic.php?pid=$obj->pid\">Upload New</a>";
                              }

														echo"</td>
                            <td><a href=\"delete_product.php?pid=$obj->pid\">
														<i class=\"glyphicon glyphicon-remove-sign\"></i></a></td>
													  </tr>";
											$c++;
										}
								?>
